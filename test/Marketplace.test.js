...
contract('Martketplace', ([deployer, seller, buyer])=>{
	let marketplace
	...
	describe('products', async ()=>{
		...
		it('creates products', async ()=>{
			...
			await marketplace.createProduct('', web3.utils.toWei('1', 'Ether'), {from: seller }).should.be.rejected;
			 // Priced
			await marketplace.createProduct('Phone X', 0, {from: seller }).should.be.rejected;
		})

		it('lists products', async ()=>{
			// Track the seller balance before purchase
			// let oldSELLerBalance
			// oldSELLerBalance = await web3.utils.eth.getBalance()
			// oldSELLer = await web3.utils.eth.BN(oldSELLer)
